    ...
    return (
      <div className="flex">
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              aria-expanded={open}
              className={cn(
                'h-[42px] w-[120px] justify-between rounded-r-none border-r-0 border-gray-300 bg-white text-sm',
                  ...
                  <CommandGroup>
                    {countries.map((country) => (
                      <CommandItem
                        ...
                        className="bg-white p-2 text-gray-900 data-[highlighted]:bg-gray-100 data-[highlighted]:text-gray-900"
                      >
                        <Check
                          className={cn(
                            'mr-2 h-4 w-4',
        ...
        <Input
          ...
          type="tel"
          className={cn(
            'h-[42px] rounded-l-none border-gray-300 bg-white',
            error && 'border-destructive focus-visible:ring-destructive',
            className,
          )}
          value={phoneNumber}
