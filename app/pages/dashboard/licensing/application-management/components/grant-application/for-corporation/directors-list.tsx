...
import type { directorsSchema } from '../../../schema/create-application';
import type { ColumnDef, SortingState } from '@tanstack/react-table';
import { Trash2 } from 'lucide-react';
import type { CorporateDirector, Person } from '../types/api';

interface DirectorsListProps {
  form: UseFormReturn<z.infer<typeof directorsSchema>>;
  onSubmit: (values: z.infer<typeof directorsSchema>) => void;
  directors?: CorporateDirector[] | Person[];
  isPending?: boolean;
...
const DirectorsList = ({
  ...
  const columns: ColumnDef<CorporateDirector | Person>[] = [
    {
      header: 'Nº',
      id: 'index',
      cell: ({ row }) => (
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10 w-full py-8 border-t">
        <div className="flex flex-col">
          <Heading className="text-[22px] font-medium mb-4.5">Directors List</Heading>
